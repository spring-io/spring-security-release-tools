...
WARNING: This action is deprecated in favor of https://github.com/spring-io/github-actions/tree/main/update-dependabot[spring-io/github-actions/update-dependabot].
